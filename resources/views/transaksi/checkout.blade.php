// File: sandyyuris/web-apotek/Web-Apotek-536ef6355ef9be9750b4405544135d8edd045b50/resources/views/transaksi/checkout.blade.php
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('transaksi.checkout') }}">
                        ...
                        <div class="mb-5">
                            ...
                            {{-- Form Alamat Pengiriman (Hanya Muncul jika Diantar dipilih) --}}
                        ...
                        <div class="card bg-light p-3 mb-4">
                            ...
                            {{-- Input tersembunyi ini tidak diperlukan lagi karena perhitungan dilakukan di backend,
                                 tapi saya simpan untuk logika JS di front-end --}}
                            <input type="hidden" id="deliveryFeeValue" value="0">
                        </div>


                        <div class="d-grid gap-2">
                            <button type="submit" class="btn main-bg text-white btn-lg fw-bold" onclick="return confirm('Apakah Anda yakin ingin memproses pesanan ini? Pastikan detail sudah benar.')">
...
@section('scripts')
<script>
    // Fungsi untuk memformat angka menjadi Rupiah (tanpa prefix Rp)
    ...
    function toggleDeliveryForm() {
        ...
        if (diantarRadio.checked) {
            ...
            // Tambahkan/set atribut 'required' jika diantar
            ...
            // Hapus atribut 'required' jika diambil di apotek
