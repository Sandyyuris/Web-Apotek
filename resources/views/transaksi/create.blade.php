...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
            {{-- Mengadaptasi gaya dengan garis aksen warna utama --}}
            <div class="card shadow-lg p-4" style="border-left: 6px solid #1abc9c; border-radius: 1rem;">
                <div class="card-body">
                    ...
                    {{-- Form untuk Submit Produk. Action diarahkan ke route admin.produk.store --}}
                    <form method="POST" action="{{ route('admin.produk.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="id_kategori" class="form-select @error('id_kategori') is-invalid @enderror" name="id_kategori" required>
                                    ...
                                    {{-- Loop dari data $kategoris yang dikirim controller --}}
                        ...
                        {{-- Stok dan Harga Jual (dalam 1 baris) --}}
                        <div class="row">
